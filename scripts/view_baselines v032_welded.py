...
class OptionCSwingPolicy:
    def __init__(self, env, total_swing_steps=40): 
        ...
        # Pushing the end angle further to -135 degrees brings to a physical limit of the shoulder joint that can't be overcome
        # It translates the radians into an adimensional value between 1 and -1, that are telling to the robot to reach or not its limits 
...
def view_baseline():
    ...
    with mujoco.viewer.launch_passive(env.model, env.data) as viewer:
        ...
        for episode in range(10): 
            ...
            # add here the time to get steady back with the torso in a tolerance of +-5° of tilting
            # add here also the maximum tilting angle (pitch and roll) achieved by the torso during the dropping of the ball
