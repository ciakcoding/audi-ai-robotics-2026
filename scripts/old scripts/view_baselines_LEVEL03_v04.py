...
# ==========================================
# LEVEL 03: SLOWED-DOWN BASKETBALL CHOREOGRAPHY
# ==========================================
class OptionDBasketballPolicy:
    def __init__(self, env):
        ...
        self.keyframes = {
            0: {}, # Start with ball in right hand (down)
            
            # 1. Walk: Step Right Foot (Shift weight left)
            30: { 
                'waist_roll_joint': -0.15,
                'right_hip_pitch_joint': -0.3, 'right_knee_joint': 0.6, 'right_ankle_pitch_joint': -0.3,
            },
            
            # 2. Walk: Step Left Foot (Bring forward to align)
            60: { 
                'waist_roll_joint': 0.15,
            ...
            # 3. Stop a bit (Pause & Stabilize Center of Mass)
            85: { 
    ...
    def apply_controls(self):
        ...
        # Release the ball slightly before full extension (Frame 160 out of 165)
        return t > 160 
...
def view_baseline():
    ...
    with mujoco.viewer.launch_passive(env.model, env.data) as viewer:
        ...
        while viewer.is_running():
            ...
            # (Increased loop time to 180 to fit the longer choreography)
            # ==========================================
