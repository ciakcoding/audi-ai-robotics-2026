...
class OptionDBasketballPolicy:
    def __init__(self, env):
        ...
        self.keyframes = {
            # 0. STARTING STANCE (Elbows naturally bent, no hyperextension)
            0: { 
            ...
            # --- TRUE BASKETBALL WIND UP (ASYMMETRICAL) ---
            # Right Hand (Shooter): Elbow deeply bent directly under the ball, wrist cocked back.
            # Left Hand (Guide): Raised to the side, elbow bent.
            400: { 
                'right_shoulder_pitch_joint': -2.5, 'right_shoulder_roll_joint': 0.0,
                'right_elbow_joint': 2.2, 'right_wrist_pitch_joint': -1.0, 
                
                'left_shoulder_pitch_joint': -2.0, 'left_shoulder_roll_joint': 0.3,
                'left_elbow_joint': 1.6, 'left_wrist_pitch_joint': -0.2,
            },
            
            # --- EXPLOSIVE ASYMMETRICAL THROW ---
            # Right Hand: Shoots up and forward. Elbow STOPS at 0.15 (prevents 180+ backward bending). Wrist flicks!
            # Left Hand: Stays bent, moves slightly away from the ball.
            415: { 
                'right_shoulder_pitch_joint': -1.2, 
                'right_elbow_joint': 0.15, 
                'right_wrist_pitch_joint': 0.8, # WRIST FLICK!
                
                'left_shoulder_pitch_joint': -2.0, 'left_shoulder_roll_joint': 0.5,
            ...
            # --- RECOVER BALANCE (Lower arms safely) ---
            500: {
                'right_shoulder_pitch_joint': -0.2, 'right_elbow_joint': 0.8, 
                'left_shoulder_pitch_joint': -0.2, 'left_elbow_joint': 0.8,
                'left_hip_pitch_joint': -0.2, 'left_knee_joint': 0.4, 'left_ankle_pitch_joint': -0.2,
                'right_hip_pitch_joint': -0.2, 'right_knee_joint': 0.4, 'right_ankle_pitch_joint': -0.2,
            }
        }
