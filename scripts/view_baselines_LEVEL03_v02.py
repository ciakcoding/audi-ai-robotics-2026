...
class OptionDBasketballPolicy:
    ...
    def apply_controls(self):
        ...
        # ---------------------------------------------------------
        # FASTER STATE MACHINE (To beat gravity without RL)
        # ---------------------------------------------------------
        if t < 15:
            # PHASE 1: Step Right Foot (Lean left to balance)
            targets['waist_roll_joint'] = -0.15 
            targets['right_hip_pitch_joint'] = -0.3
            targets['right_knee_joint'] = 0.6
            targets['right_ankle_pitch_joint'] = -0.3
            
        elif t < 30:
            # PHASE 2: Step Left Foot (Lean right to balance)
            targets['waist_roll_joint'] = 0.15
            targets['left_hip_pitch_joint'] = -0.3
            targets['left_knee_joint'] = 0.6
            targets['left_ankle_pitch_joint'] = -0.3
            ...
            # PHASE 3: Gather & Crouch (Center weight, crouch deeply)
            targets['waist_roll_joint'] = 0.0
            ...
            # PHASE 4: Elongate & Shoot! (Explode upwards)
            targets['left_hip_pitch_joint'] = -0.1
            targets['left_knee_joint'] = 0.2
            targets['left_ankle_pitch_joint'] = -0.1
            targets['right_hip_pitch_joint'] = -0.1
            targets['right_knee_joint'] = 0.2
            targets['right_ankle_pitch_joint'] = -0.1
        ...
        # Return True if we have reached the exact release frame (Step 65)
        return t > 65
...
def view_baseline():
    ...
    with mujoco.viewer.launch_passive(env.model, env.data) as viewer:
        ...
        while viewer.is_running():
            ...
            # ==========================================
            # Run for 75 steps (~1.5 seconds)
            while policy.step_count < 75 and viewer.is_running():
                ...
                if should_release:
                    ...
                    if weld_id != -1:
                        # FIX: Update env.data.eq_active instead of env.model.eq_active!
