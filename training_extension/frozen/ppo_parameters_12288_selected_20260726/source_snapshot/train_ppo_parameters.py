...
def main():
    ...
    run_name = args.run_name or datetime.now().strftime(
        "ppo_cem_parameters_%Y%m%d_%H%M%S"
    )
    ...
    metadata = {
        "algorithm": "PPO parameter residual around frozen CEM v17",
    ...
    try:
        ...
        vector_env.close()
    print(f"Saved parameter PPO run: {run_dir}")
